...
# مسارات الملفات (مبنية على موقع هذا الملف لتعمل في الاستضافة)
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
# مسار ملف المدربين
TRAINERS_FILE = os.path.join(BASE_DIR, 'trainers.json')
# مسار ملف النماذج المحفوظة
FORMS_FILE = os.path.join(BASE_DIR, 'saved_forms.json')
...
def suggest_questions():
    ...
    try:
        ...
        # مفتاح API
        api_key = "AIzaSyD_bgcfFpGr82pCAcO1MH9zCvppicQje5o"
