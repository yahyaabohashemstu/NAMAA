...
document
  ...
  .addEventListener("submit", async function (e) {
    ...
    loginBtn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> جار التحقق...';
    ...
    try {
      ...
      try {
        ...
        // إذا لم تكن الاستجابة بصيغة JSON
        showError("الخادم أرجع استجابة غير متوقعة. يرجى المحاولة لاحقاً.");
        return;
      }
